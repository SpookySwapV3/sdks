...
const BTTC_ADDRESSES: ChainAddresses = {
  ...
  mixedRouteQuoterV1Address: '0x956927a62F4E6066e760560a86c305E81A38F0d3'
}
const FTM_ADDRESSES: ChainAddresses = {
  ...
  mixedRouteQuoterV1Address: '0x5F2C0cB92c064d54b2eA086327010aEA13B2fA01'
}
const EON_ADDRESSES: ChainAddresses = {
  ...
  quoterAddress: '0xB9507f2ED171D52c5c2EFaeAbdE440d264504A92',
  swapRouter02Address: '0x40F70B72796C30f355dF859B2c8F94f18c38AdF8',
  mixedRouteQuoterV1Address: '0xC87Bb454A49eaBcA632B80d5faF40CDBe410EeC2'
}
...
const BERA_TESTNET_ADDRESSES: ChainAddresses = {
  ...
  mixedRouteQuoterV1Address: '0xe7005a4Fa0260022149772EA86449431B4A9e641'
}
...
const SONIC_TESTNET_ADDRESSES: ChainAddresses = {
  ...
  quoterAddress: '0xB9507f2ED171D52c5c2EFaeAbdE440d264504A92',
  swapRouter02Address: '0x40F70B72796C30f355dF859B2c8F94f18c38AdF8',
  mixedRouteQuoterV1Address: '0xa7B257019fc65Be804fd5A2Aa2AFe64cBC9E7d37',
}
...
const SONIC_ADDRESSES: ChainAddresses = {
  ...
  quoterAddress: '0x593856bbfd6Aaf0b714277c0BF06307900d1Aa68',
  swapRouter02Address: '0x0C2BC01d435CfEb2DC6Ad7cEC0E473e2DBaBdd87',
  mixedRouteQuoterV1Address: '0x912060d9c7244A7601276c16CCb5be258F1335Df',
}
...
const GOAT_ADDRESSES: ChainAddresses = {
  ...
  quoterAddress: '0x460FF2839822f354fEf1f568f2379CA22c54B3f7',
  swapRouter02Address: '0xFefdf9234E29Dc435D5D04ebe425a0c70d2a1824',
  mixedRouteQuoterV1Address: '0x81A310EBE6FD067c8020a51FCA5c851227B51C0d',
}
